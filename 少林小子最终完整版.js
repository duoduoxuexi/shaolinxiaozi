...
lib.ssMetadata = [
		{name:"少林小子最终完整版_atlas_1", frames: [[0,0,1920,1080]]},
		{name:"少林小子最终完整版_atlas_2", frames: [[0,0,1920,1080]]},
		{name:"少林小子最终完整版_atlas_3", frames: [[0,0,1024,1024]]},
		{name:"少林小子最终完整版_atlas_4", frames: [[0,0,1024,1024]]},
		{name:"少林小子最终完整版_atlas_5", frames: [[0,0,1024,1024]]},
		{name:"少林小子最终完整版_atlas_6", frames: [[1026,0,758,554],[1026,556,758,554],[0,1026,758,554],[760,1112,758,554],[0,0,1024,1024],[0,1668,412,307],[414,1668,412,307],[1242,1668,389,279],[828,1668,412,307]]}
];
...
(lib.按下 = function() {
	this.initialize(ss["少林小子最终完整版_atlas_3"]);
	this.gotoAndStop(0);
...
(lib.按键 = function() {
	this.initialize(ss["少林小子最终完整版_atlas_4"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.按键png复制 = function() {
	this.initialize(ss["少林小子最终完整版_atlas_5"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib._1 = function() {
	this.initialize(ss["少林小子最终完整版_atlas_6"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.背景 = function() {
	this.initialize(ss["少林小子最终完整版_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.背景地板 = function() {
	this.initialize(ss["少林小子最终完整版_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib.少林小子最终完整版 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		function 显示知识卡片() {
		    // 随机选择一个知识卡片元件显示
		    var 随机卡片 = Math.floor(Math.random() * 4) + 1; // 随机生成1到4之间的整数
		    reset卡片位置(); // 重置卡片位置，确保只有一个卡片可见
		...
		this.左按钮.addEventListener("click", fl_MouseClickHandler.bind(this));
		
		function fl_MouseClickHandler() {
		    按下 = false;
		}
		
		this.右按钮.addEventListener("click", fl_MouseClickHandler_3.bind(this));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/主角哭png复制.png?1701957692994", id:"主角哭png复制"},
		{src:"images/角色removebgpreviewpng复制2.png?1701957692994", id:"角色removebgpreviewpng复制2"},
		{src:"images/少林小子最终完整版_atlas_1.png?1701957692970", id:"少林小子最终完整版_atlas_1"},
		{src:"images/少林小子最终完整版_atlas_2.png?1701957692970", id:"少林小子最终完整版_atlas_2"},
		{src:"images/少林小子最终完整版_atlas_3.png?1701957692970", id:"少林小子最终完整版_atlas_3"},
		{src:"images/少林小子最终完整版_atlas_4.png?1701957692970", id:"少林小子最终完整版_atlas_4"},
		{src:"images/少林小子最终完整版_atlas_5.png?1701957692970", id:"少林小子最终完整版_atlas_5"},
		{src:"images/少林小子最终完整版_atlas_6.png?1701957692971", id:"少林小子最终完整版_atlas_6"}
	],
	preloads: []
};
